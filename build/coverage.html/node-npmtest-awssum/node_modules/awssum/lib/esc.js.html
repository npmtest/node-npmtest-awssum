...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-awssum/node_modules/awssum/lib/esc.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-awssum">npmtest-awssum (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-awssum/node_modules/awssum/lib/esc.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-awssum/node_modules/awssum/lib/</a> &#187; esc.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// set up the hex digits and a hexMap[0..255] = ( '00', '01', ...,  'FF' )
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function esc(str) {</span>
    // firstly, use encodeURIComponent(str) to convert all the unicode and most other characters
<span class="cstat-no" title="statement not covered" >    str = encodeURIComponent(str);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if ( str[i].match( doNotEsc ) ) {</span>
<span class="cstat-no" title="statement not covered" >            result.push( str[i] );</span>
        }
        else {
<span class="cstat-no" title="statement not covered" >            result.push( '%' + hexMap[str.charCodeAt(i)] );</span>
        }
    }
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Thu Apr 20 2017 02:44:25 GMT+0000 (UTC)</div>
</div>
</body>
</html>
